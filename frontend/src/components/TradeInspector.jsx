function TradeInspector({ errors, trade, update_local, update_global }) {
    return (
        <div className="trade-inspector">
            <div className="trade-inspector-group">                
                <div className="trade-inspector-error-row">
                ...
                <p className="trade-inspector-error">{errors?.ticker_unique_id !== -1 && errors?.ticker_error}</p>
            </div>
            ...
            <div className="trade-inspector-group">
                ...
                <p className="trade-inspector-error">{errors?.ticker_unique_id !== -1 && errors?.count_error}</p>
            </div>
            ...
            <div className="trade-inspector-group">
                ...
                <p className="trade-inspector-error">{errors?.ticker_unique_id !== -1 && errors?.ticker_price_error}</p>
            </div>
            ...
            <div className="trade-inspector-group">
                ...
                <p className="trade-inspector-error">{errors?.ticker_unique_id !== -1 && errors?.sell_price_error}</p>
            </div>
            ...
            <div className="trade-inspector-group">
                ...
                <p className="trade-inspector-error">{errors?.ticker_unique_id !== -1 && errors?.type_error}</p>
            </div>
            ...
            <div className="trade-inspector-group">
                ...
                <p className="trade-inspector-error">{errors?.ticker_unique_id !== -1 && errors?.buy_date_error}</p>
            </div>
            ...
            <div className="trade-inspector-group">
                ...
                <p className="trade-inspector-error">{errors?.ticker_unique_id !== -1 && errors?.sell_date_error}</p>
            </div>
